 ...
 * @throws ApiError
 */
export const databasesExist = (data: DatabasesExistData): CancelablePromise<DatabasesExistResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const createDucklakeDatabase = (data: CreateDucklakeDatabaseData): CancelablePromise<CreateDucklakeDatabaseResponse> => { return __request(OpenAPI, {
    method: 'POST',
